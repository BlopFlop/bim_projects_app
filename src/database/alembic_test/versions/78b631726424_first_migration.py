...
def upgrade() -> None:
    ...
    sa.Column('created_on', sa.DateTime(timezone=True), nullable=False, comment='Дата и время создания проекта.'),
    sa.Column('base_path', sa.String(length=200), nullable=True, comment='Путь до базовой директории, обязательное строковое поле; допустимая длина строки — от 1 до 200 символов включительно;'),
    sa.Column('arch_path', sa.String(length=200), nullable=True, comment='Путь до архивной директории, обязательное строковое поле; допустимая длина строки — от 1 до 200 символов включительно;'),
    sa.Column('ftp_path', sa.String(length=200), nullable=True, comment='Путь до файла, обязательное строковое поле; допустимая длина строки — от 1 до 200 символов включительно;'),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False, comment='Номер в базе данных'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('created_on', sa.DateTime(timezone=True), nullable=False, comment='Дата и время создания файла.'),
    sa.Column('updated_on', sa.DateTime(timezone=True), nullable=False, comment='Дата и время обновления файла.'),
