...
import rpws
from rpws.server import RevitServer as _RevitServer

RESTService: Final[str] = "/RevitServerAdminRESTService{}/AdminRESTService.svc"


class RevitServerREST(_RevitServer):
